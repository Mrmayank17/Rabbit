...
const NavBar = () => { 
    ...
    return (
        <>
                ...
                <div className="relative container mx-auto flex items-center justify-between py-4 px-6">
                    ...
                    <div className='flex items-center space-x-4'>
                        ...
                        <button onClick={toggleCartDrawer} className='relative hover:text-black cursor-pointer'>
                            ...
                            {cartItemCount > 0 && (<span className='absolute -top-1  text-xs text-white bg-[#ea2e0e] rounded-full py-0.5 px-1 '>{cartItemCount}</span>)}
            ...
            {/* MOBILE MENU */}
            <div className={`fixed top-0 left-0 h-full w-[75%] sm:w-[50%] md:hidden shadow-lg transform z-50 transition-transform duration-300 bg-white ${mobileNavDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
