...
const Footer = () => {
    return (
            ...
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-6 '>
                ...
                <div className=''>
                    ...
                    <div className="flex space-x-4 mb-6 items-center">
                        <a href="www.facebook.com" target='_blank' rel='noreferror noopener' className='hover:text-gray-300'><TbBrandMeta className='h-5 w-5'/></a>
                        <a href="www.instagram.com" target='_blank' rel='noreferror noopener' className='hover:text-gray-300'><TbBrandInstagram className='h-5 w-5'/></a>
                        <a href="www.twitter.com" target='_blank' rel='noreferror noopener' className='hover:text-gray-300'><RiTwitterXLine className='h-5 w-5'/></a>
                    </div>
        ...
        <p className='tracking-tighter text-sm text-gray-500 text-center'>&copy; 2026, Mayank Singh. All Rights Reserved.</p>
            </div>
        </footer>
    )
}
